...
namespace Server.Ghost.Characters
{
    ...
    public class ShopData
    {
        ...
        public ShopData(int ItemID, int Quantity, int SourceType, int SourceSlot, byte TargetSlot, int Spirit,
            byte Level1, byte Level2, byte Level3, byte Level4, byte Level5, byte Level6, byte Level7, byte Level8,
            byte Level9, byte Level10, byte Fusion, byte IsLocked, int Icon, int Term, int Price)
        {
            this.ItemID = ItemID;
