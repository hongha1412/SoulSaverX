...
{
    public sealed class
        InteroperabilityClient : ClientHandler<InteroperabilityMessage, InteroperabilityMessage, BlankCryptograph>
    {
        private byte _id;
        ...
        {
            get { return (byte)(this.ExternalID - 1); }
        }
        ...
        {
            get { return LoginServer.IsAlive; }
        }
