namespace Server.Ghost
{
	public class ItemData
	{
		...
		// 武器
		public ItemData(int ItemID, string ItemName, byte Job, byte Level, short Attack, short MagicAttack,
			short AttackRange, byte Speed, int Price, byte Fusion)
		{
			this.ItemID = ItemID;
			this.ItemName = ItemName;
			this.Job = Job;
		...
		// 服裝
		public ItemData(int ItemID, string ItemName, byte Job, byte Level, short Defense, short Str, short Dex,
			short Vit, short Int, int Price, byte Fusion)
		{
			this.ItemID = ItemID;
			this.ItemName = ItemName;
			this.Job = Job;
		...
		// 帽子
		public ItemData(int ItemID, string ItemName, short Str, short Dex, short Vit, short Int, short Hp, short Mp,
			int Price)
		{
			this.ItemID = ItemID;
			this.ItemName = ItemName;
		...
		// 戒指
		public ItemData(int ItemID, string ItemName, byte Job, byte Level, short Str, short Dex, short Vit, short Int,
			short MagicAttack, short Avoid, short Attack, short Defense, short Hp, short Mp, byte Refining, int Price)
		{
			this.ItemID = ItemID;
			this.ItemName = ItemName;
			this.Job = Job;
		...
		public ItemData(int ItemID, string ItemName, byte Job, byte Level, short Attack, short MagicAttack,
			short AttackRange, byte Speed, short Hp, short Mp, int Price)
		{
			this.ItemID = ItemID;
			this.ItemName = ItemName;
			this.Job = Job;
