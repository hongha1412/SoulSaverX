...
namespace Server.Ghost
{
	public class CharacterStorages : IEnumerable<Storage>
	{
		...
		{
			Storage item =
				this.Storages.Find(i => (i.ItemID != 0 && i.Quantity != 0 && i.Type == Type && i.Slot == Slot));
		...
		{
			Storage Item = this.Storages.Find(i =>
				(i.ItemID != 0 && i.Quantity != 0 && i.Type == (byte)Type && i.Slot == Slot));
			if (Item == null)
				return 0;
			return Item.ItemID;
		}
