...
namespace Server.Handler
{
	public static class QuestHandler
	{
		...
		public static void QuestCompleteHandler(Client gc, int QuestID)
		{
			...
			{
				if (item.Type == (byte)InventoryType.ItemType.Equip &&
					item.Slot == (byte)InventoryType.EquipType.Weapon)
				{
					Item = item;
					break;
				}
			...
			switch (QuestID)
			{
				...
				case 7: // [寶芝林的藥材]
					chr.Money += 1500;
					chr.Exp += 300;
					chr.Items.Add(new Item(8810011, (byte)InventoryType.ItemType.Spend3,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Spend3), 20));
					chr.Items.Add(new Item(8820011, (byte)InventoryType.ItemType.Spend3,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Spend3), 40));
				...
				case 12: // [守衛的慰勞品2]
					chr.Exp += 100;
					chr.Rank += 2;
					chr.Items.Add(new Item(8990004, (byte)InventoryType.ItemType.Other4,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Other4)));
					StatusPacket.UpdateExp(gc);
					StatusPacket.UpdateFame(gc, 2);
					InventoryHandler.UpdateInventory(gc, 4);
					break;
				...
				case 55: // [害了了防具店的衣服材料]
					chr.Money += 10000;
					chr.Items.Add(new Item(8510031, (byte)InventoryType.ItemType.Equip2,
				...
				case 68: // [蛇腹窟 蠟燭]
					...
					chr.Items.Add(new Item(8890011, (byte)InventoryType.ItemType.Spend3,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Spend3), 5));
					InventoryHandler.UpdateInventory(gc, 3);
					InventoryHandler.UpdateInventory(gc, 4);
					break;
				case 69: // [蛇腹窟 火把]
					...
					chr.Items.Add(new Item(8890021, (byte)InventoryType.ItemType.Spend3,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Spend3), 3));
					InventoryHandler.UpdateInventory(gc, 3);
					InventoryHandler.UpdateInventory(gc, 4);
					break;
				case 76: // [材料不足]
				...
				case 78: // [少女的眼淚第1階段]
					chr.Rank += 2;
					chr.Items.Add(new Item(8990025, (byte)InventoryType.ItemType.Other4,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Other4)));
					StatusPacket.UpdateFame(gc, 2);
					InventoryHandler.UpdateInventory(gc, 4);
					break;
				...
				case 88: // [北瓶押的試驗 1階段]
					chr.Rank += 1;
					chr.Items.Add(new Item(8510041, (byte)InventoryType.ItemType.Equip2,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Equip2)));
					StatusPacket.UpdateFame(gc, 1);
					InventoryHandler.UpdateInventory(gc, 2);
					break;
				case 89: // [北瓶押的試驗 2階段]
					chr.Rank += 2;
					chr.Items.Add(new Item(8510051, (byte)InventoryType.ItemType.Equip2,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Equip2)));
					StatusPacket.UpdateFame(gc, 2);
					InventoryHandler.UpdateInventory(gc, 2);
					break;
				case 90: // [北瓶押的試驗 最後階段]
					chr.Rank += 3;
					chr.Items.Add(new Item(8510061, (byte)InventoryType.ItemType.Equip2,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Equip2)));
					StatusPacket.UpdateFame(gc, 3);
					InventoryHandler.UpdateInventory(gc, 2);
					break;
				case 91: // [尋找西米路]
					chr.Items.Add(new Item(8990032, (byte)InventoryType.ItemType.Other4,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Other4)));
				...
				case 93: // [消失的傳家寶]
					...
					break;
				case 94: // [不安的哞讀冊]
					chr.Items.Add(new Item(8810031, (byte)InventoryType.ItemType.Spend3,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Spend3), 50));
					chr.Items.Add(new Item(8820031, (byte)InventoryType.ItemType.Spend3,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Spend3), 100));
					InventoryHandler.UpdateInventory(gc, 3);
					break;
				case 95: // [遭竊的名田瞧]
					chr.Rank += 1;
				...
				case 115: // [老父親的白內障]
					...
					chr.Items.Add(new Item(8820031, (byte)InventoryType.ItemType.Spend3,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Spend3), 5));
					chr.Items.Add(new Item(8850021, (byte)InventoryType.ItemType.Spend3,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Spend3), 3));
					StatusPacket.UpdateExp(gc);
					StatusPacket.UpdateFame(gc, 2);
					InventoryHandler.UpdateInventory(gc, 3);
				...
				case 116: // [幫忙家務事1]
					...
					chr.Rank += 1;
					chr.Items.Add(new Item(8820031, (byte)InventoryType.ItemType.Spend3,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Spend3), 10));
					StatusPacket.UpdateExp(gc);
					StatusPacket.UpdateFame(gc, 1);
					InventoryHandler.UpdateInventory(gc, 3);
					break;
				case 117: // [幫忙家務事2]
					chr.Items.Add(new Item(8820031, (byte)InventoryType.ItemType.Spend3,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Spend3), 35));
					InventoryHandler.UpdateInventory(gc, 3);
					break;
				case 118: // [飛龍掌]
				...
				case 120: // [飛龍掌]
					...
					break;
				case 121: // [俠義心1]
					chr.Items.Add(new Item(8990042, (byte)InventoryType.ItemType.Other4,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Other4)));
					chr.Rank += 2;
					StatusPacket.UpdateFame(gc, 2);
					InventoryHandler.UpdateInventory(gc, 4);
					break;
				case 122: // [俠義心2]
					chr.Items.Add(new Item(8990043, (byte)InventoryType.ItemType.Other4,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Other4)));
					chr.Rank += 2;
					StatusPacket.UpdateFame(gc, 2);
					InventoryHandler.UpdateInventory(gc, 4);
				...
				case 128: // [職務代理]
					...
					chr.Items.Add(new Item(8810031, (byte)InventoryType.ItemType.Spend3,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Spend3), 5));
					chr.Items.Add(new Item(8310241, (byte)InventoryType.ItemType.Equip2,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Equip2)));
					StatusPacket.UpdateFame(gc, 1);
					InventoryHandler.UpdateInventory(gc, 3);
					InventoryHandler.UpdateInventory(gc, 2);
				...
				case 130: // [不當的買賣]
					chr.Money += 20000;
					chr.Rank += 2;
					chr.Items.Add(new Item(8090011, (byte)InventoryType.ItemType.Equip1,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Equip1)));
					chr.Items.Add(new Item(8881081, (byte)InventoryType.ItemType.Spend3,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Spend3), 100));
				...
				case 131: // [與狼牙棒叔叔摔角]
					chr.Money += 40000;
					chr.Rank += 3;
					chr.Items.Add(new Item(8210241, (byte)InventoryType.ItemType.Equip2,
						chr.Items.GetNextFreeSlot(InventoryType.ItemType.Equip2)));
					InventoryPacket.getInvenMoney(gc, chr.Money, 40000);
					StatusPacket.UpdateFame(gc, 3);
					InventoryHandler.UpdateInventory(gc, 2);
