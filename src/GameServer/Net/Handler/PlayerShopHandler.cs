	...
	public static class PlayerShopHandler
	{
		...
		public static void SellStart_Req(InPacket lea, Client c)
		{
			...
			for (int i = 0; i < 12; i++)
			{
				...
				if (Source != null)
				{
					PlayerShop.Add(new ShopData(Source.ItemID, Quantity, SourceType, SourceSlot, (byte)i,
						Source.Spirit, Source.Level1, Source.Level2, Source.Level3, Source.Level4, Source.Level5,
						Source.Level6, Source.Level7, Source.Level8, Source.Level9, Source.Level10, Source.Fusion,
