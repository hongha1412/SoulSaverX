	...
	public static class CashShopPacket
	{
		...
		public static void CashShopList1(Client c)
		{
			...
			using (OutPacket plew = new OutPacket(ServerOpcode.CASHSHOPLIST1_ACK))
			{
				...
				for (int i = 0; i < 300; i++)
				{
					plew.WriteInt(i < CashShopFactory.BoyEyesList.Count
						? CashShopFactory.BoyEyesList[i].ItemID
						: 0); // 物品ID
					plew.WriteInt(1);
					plew.WriteInt(i < CashShopFactory.BoyEyesList.Count
						? CashShopFactory.BoyEyesList[i].BargainPrice
						: 0); // 售價
					plew.WriteInt(i < CashShopFactory.BoyEyesList.Count
						? CashShopFactory.BoyEyesList[i].Term
						: 0); // 期限
					plew.WriteInt(i < CashShopFactory.BoyEyesList.Count
						? CashShopFactory.BoyEyesList[i].Price
						: 0); // 原價
				...
				for (int i = 0; i < 300; i++)
				{
					plew.WriteInt(i < CashShopFactory.GirlEyesList.Count
						? CashShopFactory.GirlEyesList[i].ItemID
						: 0); // 物品ID
					plew.WriteInt(1);
					plew.WriteInt(i < CashShopFactory.GirlEyesList.Count
						? CashShopFactory.GirlEyesList[i].BargainPrice
						: 0); // 售價
					plew.WriteInt(i < CashShopFactory.GirlEyesList.Count
						? CashShopFactory.GirlEyesList[i].Term
						: 0); // 期限
					plew.WriteInt(i < CashShopFactory.GirlEyesList.Count
						? CashShopFactory.GirlEyesList[i].Price
						: 0); // 原價
				...
				for (int i = 0; i < 300; i++)
				{
					plew.WriteInt(i < CashShopFactory.BoyHairList.Count
						? CashShopFactory.BoyHairList[i].ItemID
						: 0); // 物品ID
					plew.WriteInt(1);
					plew.WriteInt(i < CashShopFactory.BoyHairList.Count
						? CashShopFactory.BoyHairList[i].BargainPrice
						: 0); // 售價
					plew.WriteInt(i < CashShopFactory.BoyHairList.Count
						? CashShopFactory.BoyHairList[i].Term
						: 0); // 期限
					plew.WriteInt(i < CashShopFactory.BoyHairList.Count
						? CashShopFactory.BoyHairList[i].Price
						: 0); // 原價
				...
				for (int i = 0; i < 300; i++)
				{
					plew.WriteInt(i < CashShopFactory.GirlHairList.Count
						? CashShopFactory.GirlHairList[i].ItemID
						: 0); // 物品ID
					plew.WriteInt(1);
					plew.WriteInt(i < CashShopFactory.GirlHairList.Count
						? CashShopFactory.GirlHairList[i].BargainPrice
						: 0); // 售價
					plew.WriteInt(i < CashShopFactory.GirlHairList.Count
						? CashShopFactory.GirlHairList[i].Term
						: 0); // 期限
					plew.WriteInt(i < CashShopFactory.GirlHairList.Count
						? CashShopFactory.GirlHairList[i].Price
						: 0); // 原價
				...
				for (int i = 0; i < 300; i++)
				{
					plew.WriteInt(i < CashShopFactory.Face1List.Count
						? CashShopFactory.Face1List[i].ItemID
						: 0); // 物品ID
					plew.WriteInt(1);
					plew.WriteInt(i < CashShopFactory.Face1List.Count
						? CashShopFactory.Face1List[i].BargainPrice
						: 0); // 售價
				...
				for (int i = 0; i < 300; i++)
				{
					plew.WriteInt(i < CashShopFactory.Face2List.Count
						? CashShopFactory.Face2List[i].ItemID
						: 0); // 物品ID
					plew.WriteInt(1);
					plew.WriteInt(i < CashShopFactory.Face2List.Count
						? CashShopFactory.Face2List[i].BargainPrice
						: 0); // 售價
				...
				for (int i = 0; i < 300; i++)
				{
					...
					plew.WriteInt(1);
					plew.WriteInt(i < CashShopFactory.HatList.Count
						? CashShopFactory.HatList[i].BargainPrice
						: 0); // 售價
		...
		public static void CashShopList2(Client c)
		{
			...
			using (OutPacket plew = new OutPacket(ServerOpcode.CASHSHOPLIST2_ACK))
			{
				...
				for (int i = 0; i < 300; i++)
				{
					plew.WriteInt(i < CashShopFactory.BoyDressList.Count
						? CashShopFactory.BoyDressList[i].ItemID
						: 0); // 物品ID
					plew.WriteInt(1);
					plew.WriteInt(i < CashShopFactory.BoyDressList.Count
						? CashShopFactory.BoyDressList[i].BargainPrice
						: 0); // 售價
					plew.WriteInt(i < CashShopFactory.BoyDressList.Count
						? CashShopFactory.BoyDressList[i].Term
						: 0); // 期限
					plew.WriteInt(i < CashShopFactory.BoyDressList.Count
						? CashShopFactory.BoyDressList[i].Price
						: 0); // 原價
				...
				for (int i = 0; i < 300; i++)
				{
					plew.WriteInt(i < CashShopFactory.GirlDressList.Count
						? CashShopFactory.GirlDressList[i].ItemID
						: 0); // 物品ID
					plew.WriteInt(1);
					plew.WriteInt(i < CashShopFactory.GirlDressList.Count
						? CashShopFactory.GirlDressList[i].BargainPrice
						: 0); // 售價
					plew.WriteInt(i < CashShopFactory.GirlDressList.Count
						? CashShopFactory.GirlDressList[i].Term
						: 0); // 期限
					plew.WriteInt(i < CashShopFactory.GirlDressList.Count
						? CashShopFactory.GirlDressList[i].Price
						: 0); // 原價
				...
				for (int i = 0; i < 300; i++)
				{
					plew.WriteInt(i < CashShopFactory.MantleList.Count
						? CashShopFactory.MantleList[i].ItemID
						: 0); // 物品ID
					plew.WriteInt(1);
					plew.WriteInt(i < CashShopFactory.MantleList.Count
						? CashShopFactory.MantleList[i].BargainPrice
						: 0); // 售價
				...
				for (int i = 0; i < 300; i++)
				{
					plew.WriteInt(i < CashShopFactory.ProduceList.Count
						? CashShopFactory.ProduceList[i].ItemID
						: 0); // 物品ID
					plew.WriteInt(1);
					plew.WriteInt(i < CashShopFactory.ProduceList.Count
						? CashShopFactory.ProduceList[i].BargainPrice
						: 0); // 售價
					plew.WriteInt(i < CashShopFactory.ProduceList.Count
						? CashShopFactory.ProduceList[i].Term
						: -1); // 期限
					plew.WriteInt(i < CashShopFactory.ProduceList.Count
						? CashShopFactory.ProduceList[i].Price
						: 0); // 原價
		...
		public static void CashShopList3(Client c)
		{
			...
			using (OutPacket plew = new OutPacket(ServerOpcode.CASHSHOPLIST3_ACK))
			{
				...
				for (int i = 0; i < 300; i++)
				{
					plew.WriteInt(i < CashShopFactory.AmuletList.Count
						? CashShopFactory.AmuletList[i].ItemID
						: 0); // 物品ID
					plew.WriteInt(1);
					plew.WriteInt(i < CashShopFactory.AmuletList.Count
						? CashShopFactory.AmuletList[i].BargainPrice
						: 0); // 售價
				...
				for (int i = 0; i < 300; i++)
				{
					plew.WriteInt(i < CashShopFactory.TalismanList.Count
						? CashShopFactory.TalismanList[i].ItemID
						: 0); // 物品ID
					plew.WriteInt(1);
					plew.WriteInt(i < CashShopFactory.TalismanList.Count
						? CashShopFactory.TalismanList[i].BargainPrice
						: 0); // 售價
					plew.WriteInt(i < CashShopFactory.TalismanList.Count
						? CashShopFactory.TalismanList[i].Term
						: 0); // 期限
					plew.WriteInt(i < CashShopFactory.TalismanList.Count
						? CashShopFactory.TalismanList[i].Price
						: 0); // 原價
		...
		public static void CashShopList4(Client c)
		{
			...
			using (OutPacket plew = new OutPacket(ServerOpcode.CASHSHOPLIST4_ACK))
			{
				...
				for (int i = 0; i < 300; i++)
				{
					...
					plew.WriteInt(1);
					plew.WriteInt(i < CashShopFactory.PetList.Count
						? CashShopFactory.PetList[i].BargainPrice
						: 0); // 售價
